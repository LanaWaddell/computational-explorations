...
This work is developed alongside the Python Programming MOOC from the University of Helsinki, with an emphasis on applying programming to scientific and systems-based problems.
